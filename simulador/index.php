            ...
            <div class="fila">
              <div class="col xs12 lg6">
                <div class="intro__item">
                  ...
                  <div class="intro__content observar" style="margin-bottom: 26px;">
                    <p>Bienvenido.</p>
                    <p>Por favor selecciona cómo te quieres registrar.</p>
                  </div>
                  <div class="intro__buttons observar">
                    <div class="intro__btn"><a class="btn btn--secundario" href="paso-toc-select.php">PERSONA NATURAL</a>
                    ...
                    <div class="intro__btn intro__btn--juridica"><a class="btn btn--secundario" href="paso-previo_pj.php">PERSONA JURÍDICA</a>
					...
					<p style="text-align:center; margin:24px 0 0 0;">¿Ya eres cliente? <a href="/sitioprivado">ingresa aquí</a></p>
                </div>
              </div>
              <div class="col xs12 lg6">
                <div class="intro__item intro__item--blue observar">
                  <h2>¿Quieres Simular?</h2>
                  <p style="margin-bottom: 26px;">Atrévete a Simular tu inversión con nuestro Simulador...</p>
                  <p></p>
                  <p></p>
                  <p></p>
                  <div class="intro__buttons observar">
                    <div class="intro__btn"><a class="btn btn--secundario" href="registro_cliente_simulacion.php">SIMULAR</a>
                      <p>Cliente Persona Natural <span class="intro-tooltip" data-tippy-placement="bottom" data-tippy-arrow="true" data-tippy-content="Registrate">?</span></p>
                    </div>
                  </div>
                  <div class="intro__buttons observar">
                    <div class="intro__btn"><a class="btn btn--secundario" href="horizontal/index.html">DASHBOARD</a>
                      <p>Cliente Persona Natural <span class="intro-tooltip" data-tippy-placement="bottom" data-tippy-arrow="true" data-tippy-content="Registrate">?</span></p>
                    </div>
                  </div>
                </div>
