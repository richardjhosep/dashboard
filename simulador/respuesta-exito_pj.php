              ...
              <div class="col xs12 lg10 offset-lg1">
                <div class="respuestas__item observar">
                  ...
                  <div class="respuestas__texto">
                    <h2>Éxito</h2>
                    <p>Gracias por completar el proceso. Desde este momento se revisarán la información y los antecedentes entregados. Informaremos el estado de la revisión.</p>
                    <p>Ante la posibilidad de requerir o precisar los antecedentes, nos pondremos en contacto con <strong><?php echo $_SESSION['nombreCompleto'] ?> <?php echo $_SESSION['apellido-paterno'] ?></strong>.</p>
                    <p>Una vez terminado este proceso, se les comunicará a los Representantes Legales con las facultades para proceder con la firma de los contratos.</p>
                  </div>
                  <!--div class="respuestas__buttons"><a class="btn btn--secundario" href="#">Terminar</a></div-->
                </div>
              </div>
            </div>
          </div>
